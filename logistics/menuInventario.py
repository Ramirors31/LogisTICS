...
class MenuInventario(object):
    def setupUi(self, inventario):
        ...
        self.inventarioTable.setGeometry(QtCore.QRect(50, 130, 950, 400))
        ...
        #AJUSTANTO TAMAÑO DE COLUMNAS TABLA
        self.header = self.inventarioTable.horizontalHeader()
        ...
        self.addProductoBtn.setGeometry(QtCore.QRect(50, 20, 171, 51))
        font = QtGui.QFont()
...
"background-color: rgb(118, 136, 135);")
        ...
        self.buscarProductoText.setGeometry(QtCore.QRect(570, 20, 301, 51))
        self.buscarProductoText.setObjectName("buscarProductoText")
        self.buscarProductoBtn = QtWidgets.QPushButton(self.frame)
        self.buscarProductoBtn.setGeometry(QtCore.QRect(900, 20, 171, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"background-color: rgb(118, 136, 135);")
        ...
        self.modificarBtn.setGeometry(QtCore.QRect(320, 20, 171, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"background-color: rgb(118, 136, 135);")
        ...
        self.btnRegresar.setGeometry(QtCore.QRect(20, 5, 70, 70))
    ...
    def retranslateUi(self, inventario):
        ...
        for distribuidor in listaProductos:
                ...
                self.inventarioTable.setItem(row, 6, QtWidgets.QTableWidgetItem(str(distribuidor[6])))
