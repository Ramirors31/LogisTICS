...
class MenuLogistica(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(0, 90, 1141, 501))
        ...
        self.pedidosTable.setGeometry(QtCore.QRect(0, 60, 881, 192))
        ...
        self.nuevoPedidoBtn.setGeometry(QtCore.QRect(920, 70, 191, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"background-color: rgb(118, 136, 135);")
        ...
        self.buscarPedidoBtn.setGeometry(QtCore.QRect(1030, 250, 81, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"background-color: rgb(118, 136, 135);")
        ...
        self.buscarPedidoText.setGeometry(QtCore.QRect(920, 250, 101, 51))
        self.buscarPedidoText.setObjectName("buscarPedidoText")
        self.distribuidoresBtn = QtWidgets.QPushButton(self.frame)
        self.distribuidoresBtn.setGeometry(QtCore.QRect(920, 150, 191, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"background-color: rgb(118, 136, 135);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Últimos Pedidos"))
