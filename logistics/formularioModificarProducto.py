...
class FormularioModificar(object):
    def setupUi(self, ModificarEliminarProducto):
        ...
        ModificarEliminarProducto.resize(800, 517)
        ...
        self.btnRegresar.setGeometry(QtCore.QRect(20, 20, 61, 51))
        ...
        self.frame.setGeometry(QtCore.QRect(0, 80, 811, 471))
        ...
        self.productoTxt.setGeometry(QtCore.QRect(160, 10, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 90, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.descripcionTxt = QtWidgets.QTextEdit(self.frame)
        self.descripcionTxt.setGeometry(QtCore.QRect(160, 90, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 170, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.distribuidorText = QtWidgets.QTextEdit(self.frame)
        self.distribuidorText.setGeometry(QtCore.QRect(160, 170, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_5.setGeometry(QtCore.QRect(20, 250, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.frame)
        self.label_6.setGeometry(QtCore.QRect(20, 330, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.precioCompraTxt = QtWidgets.QTextEdit(self.frame)
        self.precioCompraTxt.setGeometry(QtCore.QRect(160, 250, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.precioVentaTxt.setGeometry(QtCore.QRect(160, 330, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"background-color: rgb(236, 0, 3);")
    ...
    def retranslateUi(self, ModificarEliminarProducto):
        ...
        self.label_2.setText(_translate("ModificarEliminarProducto", "ID o Nombre:"))
        self.label_3.setText(_translate("ModificarEliminarProducto", "Descripcion:"))
        self.label_4.setText(_translate("ModificarEliminarProducto", "Distribuidor:"))
        self.label_5.setText(_translate("ModificarEliminarProducto", "Precio Compra:"))
        self.label_6.setText(_translate("ModificarEliminarProducto", "Precio Venta:"))
